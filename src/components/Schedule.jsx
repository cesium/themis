              ...
              <div className="-ml-4 flex w-screen justify-between px-4">
                ...
                <div className="text-center">
                  ...
                  <time
                    ...
                    className="mt-1.5 block text-2xl font-semibold tracking-tight text-jordi-orange-400 sm:ml-0"
                  >
                    {day.date}
                  </time>
                </div>
      ...
      {day.timeSlots.map((timeSlot, timeSlotIndex) => (
        ...
        >
          ...
          {timeSlot.description && (
            <p className="mt-1 tracking-tight text-jordi-black">
              {timeSlot.description}
            </p>
          )}
          <p className="mt-1 font-mono text-sm text-jordi-orange-300">
  ...
  return (
    ...
    >
      ...
      <div className="relative mt-14 sm:mt-24">
        <div className="absolute inset-x-0 -top-40 -bottom-32 overflow-hidden bg-white">
          <Image
            ...
            unoptimized
          />
          <div className="absolute inset-x-0 top-0 h-40 bg-gradient-to-b from-jordi-beige-50" />
          <div className="from-jordi-white absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t" />
        </div>
